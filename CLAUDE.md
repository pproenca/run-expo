...
It was reimagined *from the extracted spec*, not ported. The legacy at
`/Users/pedroproenca/Documents/Projects/expo98` (symlinked at `../../legacy/expo98`,
**READ-ONLY**) is the *specification source*. Do not copy its structure — it carries
...
*impossible to reintroduce*: it's proven at the type level in

...
import { doctor as legacyDoctor, projectInfo } from "./commands/project-info-doctor/src/main/index.ts";
...
import { consoleCommand, devtoolsCommand, errorsCommand } from "./commands/devtools-diagnostics/src/main/index.ts";
...
import { controlsCommand, stateCommand, storageCommand } from "./commands/bridge-domain-actions/src/main/index.ts";
...
import { debugInspectCommand, highlightCommand } from "./commands/debug-inspect-highlight/src/main/index.ts";

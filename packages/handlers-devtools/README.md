...
never invoked — the _behavioural_ proof, asserted as zero capability calls in the
denial tests. The _structural_ proof is the type system: a `read`-classed handler

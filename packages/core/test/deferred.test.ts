...
describe("Deferred ACs (handler/integration packages)", () => {
  it.skip("AC-005 device/app lifecycle mutations gated — full xcrun/simctl handler behavior in packages/handlers-lifecycle; gate mechanism proven by dispatch.test + capability-injection.test", () => {})
  ...
  it.skip("AC-010 trace gated as runtime-eval — full handler behavior in packages/handlers-devtools; mechanism proven by capability-injection.test", () => {})
  it.skip("AC-011 inspector mutations gated, reads classified read — full handler behavior in packages/handlers-devtools; mechanism proven by capability-injection.test", () => {})
})

...
export const sessionDir = (l: Layout, sessionId: string): string =>
  join(sessionsDir(l), sessionId)

export const sessionFile = (l: Layout, sessionId: string): string =>
  join(sessionDir(l, sessionId), "session.json")

export const targetFile = (l: Layout, sessionId: string): string =>
  join(sessionDir(l, sessionId), "target.json")

export const refsFile = (l: Layout, sessionId: string): string =>
  join(sessionDir(l, sessionId), "refs.json")

export const snapshotsDir = (l: Layout, sessionId: string): string =>
  join(sessionDir(l, sessionId), "snapshots")
...
export const artifactsDir = (l: Layout, sessionId: string): string =>
  join(sessionDir(l, sessionId), "artifacts")
 ...
 */
export const runRecordFile = (stateDir: string, runId: string): string =>

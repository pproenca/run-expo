...
*Companion to `BUSINESS_RULES.md`, extracted on 2026-05-24 from the live `legacy/expo98/src/**` tree.*
*Paths are relative to `legacy/expo98/`. These are the core records/envelopes the business rules consume and produce — the "nouns" the strangler-fig / rebuild must preserve at the package boundary.*
...
### SessionRecord  *[on disk: `session.json`]*
...
### RunningRunRecord → FinishedRunRecord  *[on disk: `<runId>.json`]*
...
### TargetRecord  *[on disk: `target.json`]*
...
### SnapshotResult  *[on disk: `snapshots/<snapshotId>.json`]*
...
### BridgeMetadata  *[on disk: `.expo98/bridge.json`]*
...
### OverlayEventsFile  *[on disk: `events.json`]*

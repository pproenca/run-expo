...
*Backbone: `analysis/expo98/DATA_OBJECTS.md`. Field types cross-checked against `legacy/expo98/src/**/domain.ts` (cited inline). Target shape: Effect Schema / tagged structs.*
